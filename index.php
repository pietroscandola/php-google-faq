...
$google_faq = [
    ...
    [
        ...
        "answers" => [
            ...
            '<ol type="a"><li>Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell\'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.',
...
<body>
    <main class="container">
        <?php foreach ($google_faq as $question => $texts) : ?>
            ...
            <?php foreach ($texts['answers'] as $paragraph) : ?>
